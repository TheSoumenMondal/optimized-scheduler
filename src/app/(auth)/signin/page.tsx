  ...
  return (
    <div className="w-full h-screen flex items-center justify-center dark:bg-black ">
      <div className="w-auto h-auto p-6 space-y-4 rounded-2xl text-center">
        <h1 className="text-2xl pl-0 font-semibold px-8 tracking-tight">
          Welcome back to <Link href={"/"} className="font-bold">Scheduler</Link>
        </h1>
        <p className="w-full pl-0 text-start text-gray-400 text-sm font-bold">
